...
lyr_Outputpointlayer_1.set('fieldLabels', {'name': 'no label', 'folders': 'hidden field', 'descriptio': 'hidden field', 'altitude': 'hidden field', 'alt_mode': 'hidden field', 'time_begin': 'hidden field', 'time_end': 'hidden field', 'time_when': 'hidden field', 'estado': 'no label', });
